...
public class StandardVideoController extends BaseVideoController implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    protected void initView() {
        ...
        popupMenu = new PopupMenu(getContext(), controllerView.findViewById(R.id.mark), Gravity.LEFT);
        ...
        switch (playerState) {
            ...
            case YinYangPlayer.PLAYER_FULL_SCREEN:
                ...
                postDelayed(new Runnable() {//解决ListView无效问题
                    @Override
                    public void run() {
                        setLayoutParams(new FrameLayout.LayoutParams(Constants.SCREEN_HEIGHT, Constants.SCREEN_WIDTH));
                    }
                }, 300);
                gestureEnabled = true;
